    @section('css')
        ...
        <link href="{{ asset('wizard/assets/css/themify-icons-demo.css') }}" rel="stylesheet">
    @endsection
                                ...
                                <div class="tab-pane" id="description">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Example</label>
                                                <p class="description">"The place is really nice. We use it every
                                                    sunday when we go fishing. It is so awesome."</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
