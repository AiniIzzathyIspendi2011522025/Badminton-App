                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-default p-5">
                                {{ Form::open(['method' => 'PATCH', 'url' => route('owner.venue.fieldScheduleUpdate', $fields->id), 'id' => 'form', 'files' => true]) }}
...
@section('script')
    ...
    <script>
        ...
        function ajaxHour(select, x, y) {
            $.ajax({
                url: "{{ url('api/venue/opening-hour') }}?venue_id={{ $fields->Venue->id }}&&day_id=" + select,
                dataType: 'json',
                cache: false,
                dataSrc: '',
