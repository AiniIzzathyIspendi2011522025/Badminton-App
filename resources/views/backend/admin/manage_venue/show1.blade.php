            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.venue.index.admin') }}">Lapangan</a>
                        </li>
                                            ...
                                            {{-- <div class="ticket-sender-picture img-shadow"
                                                ...
                                                @if ($venues->owner->avatar == null)
                                                    <img src="{{ asset('templates/img/avatar/avatar-5.png') }}"
                                                        alt="image">
                                                @else
                                                    <img src="{{ asset('images/owner/' . $venues->owner->avatar) }}"
                                                        alt="image">
                                                @endif
                                            </div> --}}
                                        ...
                                        <div class="ticket-description">
                                            ...
                                            <figure>
                                                <img style="width:300px;;height:200px;"
                                                    src="{{ asset('templates/img/avatar/avatar-5.png') }}" alt="">
                                            </figure>
                                            </p>
