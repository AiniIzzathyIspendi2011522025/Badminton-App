        ...
        <section class="section">
            <div class="d-flex justify-content-center align-items-center" style="margin-top: 150px;">
                <div class="card text-center" style="width: 750px;">
                    <form action="/forgot-password/validate-act" method="POST">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div data-mdb-input-init class="form-outline">
                                <label class="form-label mr-auto" for="typeEmail">New Password</label>
                                <input type="password" name="password" class="form-control my-3"required />
                            </div>
                            <div data-mdb-input-init class="form-outline">
                                <label class="form-label" for="typeEmail">Confirmation Password</label>
                                <input type="password" name="password_confirmation" class="form-control my-3"required />
                            </div>
